...
export default function CardsSection({ isFlip, isShuffle, Card }) {
  ...
  return (
    ...
    <section className="flex justify-center w-full gap-10 mb-5">
      <div className="flex max-w-full max-h-full justify-center ">
        ...
        <TbPlayCard size={320} className={`absolute fill-red-700 z-30 ${animateClass} rotate-y-180 ${isFlip? "rotate-y-360": ""}`}/>
        <TbPlayCard size={320} className={`absolute fill-red-700 ${isShuffle ? "translate-x-0 translate-y-0 z-30" : "translate-4 z-20"}`}/>
      ...
      <div className="flex max-w-full maxh-full justify-center">
        ...
        <TbPlayCard size={320} className={`absolute fill-cyan-400 z-30 ${animateClass} rotate-y-180 ${isFlip? "rotate-y-360": ""}`}/>
        <TbPlayCard size={320} className={`absolute fill-cyan-400 ${isShuffle ? "translate-x-0 translate-y-0 z-30" : "translate-4 z-20"}`}/>
